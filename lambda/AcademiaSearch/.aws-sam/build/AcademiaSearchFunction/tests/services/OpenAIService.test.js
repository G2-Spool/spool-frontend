...
describe('OpenAIService', () => {
    ...
    beforeEach(() => {
        ...
        service = new OpenAIService_1.OpenAIService('test-api-key');
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
DESCRIPTION_5: Computational neuroscience bridges biological neural systems and artificial neural networks, exploring how the brain processes information and how these principles can be applied to artificial intelligence systems. This interdisciplinary field combines neurobiology, psychology, and computer science.`
        ...
        it('should handle OpenAI API errors', async () => {
            ...
            await expect(service.analyzeAcademicTopics('Test question', mockStudentProfile)).rejects.toThrow('Failed to analyze academic topics');
        });
        it('should handle empty OpenAI response', async () => {
            ...
            mockOpenAI.chat.completions.create.mockResolvedValue(mockResponse);
            await expect(service.analyzeAcademicTopics('Test question', mockStudentProfile)).rejects.toThrow('No response from OpenAI');
        });
