  ...
  if (isLoading) {
    return (
      <div className="flex h-screen">
        ...
        <div className="w-80 bg-gray-50 p-4 animate-pulse">
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <Card className="max-w-md text-center p-8">
          <h2 className="text-xl font-semibold text-red-600 mb-2">Thread Not Found</h2>
          ...
          <div className="mb-8">
            ...
            <Card className="bg-blue-50 border-blue-200 p-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Your Learning Focus</h3>
                  <p className="text-blue-800 text-sm">{thread.analysis.summary}</p>
            ...
            <div className="space-y-6">
              <Card className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h2 className="text-2xl font-semibold text-obsidian mb-2">
                ...
                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="font-semibold text-yellow-900 mb-1">Learning Tip</h4>
                ...
                <Card className="mt-6 p-4 bg-purple-50 border-purple-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-purple-900 mb-1">Reflection Question</h4>
